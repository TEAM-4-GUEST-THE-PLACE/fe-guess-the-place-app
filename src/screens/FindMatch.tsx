...
export default function FindMatch() {
    ...
    const socket = io("https://aace-2404-8000-1095-99a-14b4-8e00-e1a4-b94b.ngrok-free.app");
    ...
    function exitRoom() {
        const userExitRoom = userLists && userLists.filter((user) => user.username === dataUserLogin?.fullname);
