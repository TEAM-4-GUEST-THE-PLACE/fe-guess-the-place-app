    ...
    return (
        <ImageBackground source={bg1} style={styles.container}>
            <View w="85%" h="85%" bg="rgba(0,0,0,0.4)" borderRadius={20}>
                ...
                <View display="flex" justifyContent="center" alignItems="center" mt={50}>
                    <Image
                        alt="place-image"
                        source={"https://img.freepik.com/free-photo/statue-liberty-new-york_268835-778.jpg?t=st=1710472135~exp=1710475735~hmac=6912cdb34c55d3d813900d0ac88211812c0807a84abfc765651726fbf6567bc9&w=360"}
                        w={300}
                        h={300}
                        borderRadius={20}
                    />
                ...
                <View gap={20} mt={50} display="flex" justifyContent="center" alignItems="center">
                    <Button w="80%" bg="#fff">
                        <ButtonText color="#000" fontSize={20}>
                            London
                        </ButtonText>
                    </Button>
                    <Button w="80%" bg="#fff">
