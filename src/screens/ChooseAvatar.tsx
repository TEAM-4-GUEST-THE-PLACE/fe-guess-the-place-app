import { Text, StyleSheet, Dimensions, ImageBackground, TouchableOpacity, StatusBar } from "react-native";
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior="position">
                <View display="flex" justifyContent="center" alignItems="center">
                    ...
                    <View style={{ marginTop: 10 }}>
                        <Button style={{ width: 300, backgroundColor: "green" }} size="md" variant="solid" action="primary" isDisabled={false} isFocusVisible={false} onPress={postDataUser}>
