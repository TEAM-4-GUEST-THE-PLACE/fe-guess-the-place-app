...
export default function SplashScreen() {
    ...
    return (
        <ImageBackground source={bg1} style={styles.container}>
            ...
            <Button size="md" variant="solid" action="primary" isDisabled={false} isFocusVisible={false} onPress={() => navigation.navigate("FindMatch" as never)}>
                <ButtonText>Find Match</ButtonText>
            </Button>
